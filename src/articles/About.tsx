...
const data: ArticleProps = {
    ...
    content: [
        ...
        <p>
            ...
            after economic harships began to affect everyday life in DR. I didnt
            even know what a coat was, let alone what awaited us in the United
            States.
        </p>,
        ...
        <p>
            ...
            are minorities built a perspective within me to look at situations
            from the eyes of those who have just arrived to the United States.
            We learned the customs and the language, and partook in American
            traditions while still being nestled in Providence's community
            bubble.
        </p>,
        <h2> BOS 4L </h2>,
        <p></p>,
